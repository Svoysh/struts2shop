 ...
 * @author tm_jee
 * @version $Date: 2009-07-23 19:46:50 +0200 (Do, 23 Jul 2009) $ $Id: LocalizedTextUtil.java 2026 2009-07-23 17:46:50Z musachy $
 */
    ...
    public static ResourceBundle findResourceBundle(String aBundleName, Locale locale) {
        ...
        try {
            if (!bundlesMap.containsKey(key)) {
                // "ResourceBundle.getBundle()" replaced by "J18n.getBundle()"
                // to support UTF-8 in "*.properties" files.
                bundle = J18n.getBundle(
                        aBundleName,
                        locale,
