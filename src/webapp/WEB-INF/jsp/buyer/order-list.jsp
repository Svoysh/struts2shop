			...
			<table class="ListTable">
				...
				<s:iterator value="orders" status="num">
					<tr class="<s:property value="#num.odd == true ? 'Odd' : 'Even'"/>">
						...
						<td class="Number">
							<s:url action="order" namespace="/buyer" var="viewOrderUrl">
								<s:param name="id" value="%{id}"/>
							</s:url>
							<s:a href="%{#viewOrderUrl}"><s:property value="number"/></s:a>
						</td>
						<td>TODO</td>
						<td>
						...
						<td class="Number">
							<s:url action="order!items" namespace="/buyer" var="orderItemspUrl">
								<s:param name="id" value="id"/>
							</s:url>
